    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            /*-------------------------------- Duración -------------------------------*/
                ...
                ->add('totalHoras', IntegerType::class, ['label' => 'Horas totales del evento: '])
                ->add('horario', TextareaType::class, ['label' => 'Horario: ','data' => 'Descripción del horario a cubrir por el servicio'])
            /*---------------------------- Datos del evento --------------------------*/
